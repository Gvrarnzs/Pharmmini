...
const EditmodalMedicine = ({openEdit, handleModalEdit, dataEditin }) => {
    ...
    const editDataClick = async() => {
        try {
            const userDoc = doc(db, "medin",dataEditin?.id )
        ...
        <div className='bg-gray-400'>
            ...
            >
                <Box sx={style}>
                    ...
                    <TextfieldCustom 
                        name = "status"
                        defaultValue = {dataEditin?.status}
                        onChange= {inputHandler}
                        label = 'Status'
                        id='custom-css-outlined-input'
                        sx={{ mt: 1 }}
...
export default EditmodalMedicine
